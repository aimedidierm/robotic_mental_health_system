...
<div class="sm:ml-64">
    <div class="px-4 py-28 relative overflow-x-auto">
        <div class="flex justify-between pb-4">
            <h2 class="text-xl text-grey-800 dark:text-white font-semibold mb-4">Your testimonies</h2>
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <form action="/doctor/testimonies" method="post">
                            @csrf
                            <div class="mb-6">
                                <label for="Comment"
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 neumorphic">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <a type="submit" href="/doctor/testimonies/{{$item->id}}"
